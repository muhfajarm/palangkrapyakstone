...
{{-- <div class="form-group col-xs-12">
	...
	<textarea class="form-control" style="resize:none;width:570px;" rows="5" name="deskripsi" id="deskripsi" required="required"></textarea>
</div> --}}
...
<div class="form-group  col-xs-3">
	<label for="harga_jual_3" class="col-form-label">Harga Jual 3 :</label>
