...
<body onload="myFunction()">
  ...
  <header class="mb-3">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="d-flex">
            <a id="popoverData" href="{{ route('front.list_cart') }}" class="my-auto mr-auto" rel="popover" data-placement="bottom" data-original-title="Keranjang Belanja" data-trigger="hover">
            @if ($totalcart < 100)
              <span class="angkacart">{{ $totalcart }}</span>
            @else
              <span class="angkacart">{{ \Str::limit(999, 2, '+') }}</span>
            @endif
  ...
  <div class="ajax-load text-center" style="display:none">
    <p><img src="http://demo.itsolutionstuff.com/plugin/loader.gif">Memuat...</p>
  </div>
